...
class ShEDSystem(BaseSystem):
    ...
    Permutes FRAC_TO_PERMUTE of embeddings within an example.
    ...
    def __init__(self, config):
        ...
        self.FRAC_TO_PERMUTE = self.config.trainer.shed_frac
    ...
    def permute_embeddings(self, embs):
        ...
        '''
        num_to_permute = int(np.ceil(embs.size(1) * self.FRAC_TO_PERMUTE))
